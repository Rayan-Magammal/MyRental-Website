...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $userPhoto = isset($_FILES['user_photo']['name']) ? $_FILES['user_photo']['name'] : '';
    $userPhotoTmp = isset($_FILES['user_photo']['tmp_name']) ? $_FILES['user_photo']['tmp_name'] : '';
    ...
    // If there are no validation errors, update the user profile
    if (empty($errors)) {
        ...
        $targetFilename = uniqid() . '_' . $userPhoto;

        // Move the uploaded photo to the target directory
        $targetPath = $targetDirectory . $targetFilename;
        move_uploaded_file($userPhotoTmp, $targetPath);

        // Update the user photo in the database
        $updateUser = "UPDATE table_user SET user_name='$userName', user_email='$userEmail', user_password='$userPassword' user_photo='$targetPath' WHERE user_id='$userId'";
        $resultPhoto = mysqli_query($conn, $updateUser);
    ...
    <div class="container">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="name" name="name" value="<?php echo $userData['user_name']; ?>">
            </div>
            <div class="mb-3">
