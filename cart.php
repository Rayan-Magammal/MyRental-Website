...
// $carId = $_GET['car_id'];
$getCart = "SELECT table_car.*, table_cart.* FROM table_cart
INNER JOIN table_car ON table_cart.car_id = table_car.car_id
WHERE table_cart.user_id = $userId";
...
$getCart .= " LIMIT $startingResultIndex, $resultPerPage";
            ...
            <div class="row">
                ...
                ?>
                        <div class="card mb-4">
                            <div class="row g-0">
                                <div class="col-md-2">
                                    <img src="<?php echo $row['car_image']; ?>" class="img-fluid rounded-3" alt="Cotton T-shirt">
                                </div>
                                <div class="col-md-6">
                                    <div class="card-body">
                                        <h5 class="card-title"><?php echo $row['cart_id']; ?></h5>
                                        <p class="card-text">Location: <?php echo $row['car_state']; ?>" | Type: <?php echo $row['car_type']; ?>"</p>
                                    </div>
                                </div>

                                <div class="col-md-2 d-flex align-items-center justify-content-end">
                                    <h5 class="mb-0">RM<?php echo $row['car_price']; ?>/hour</h5>
                                </div>
                                <div class="col-md-2 d-flex align-items-center justify-content-end">
                                    <form method="post">
                                        ...
                                        <button class="btn btn-success shadow-0" type="submit" name="rent">Rent Now</button>
                                    </form>
                                </div>
                            </div>
                        </div>
